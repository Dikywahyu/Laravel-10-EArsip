  ...
  <div id="main-wrapper">
    ...
    <div class="page-wrapper">
      <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive m-t-20">
                  <table id="datatable-main" class="display nowrap table table-hover table-striped border"
        ...
        <div id="MTData" class="modal" tabindex="-1" role="dialog" aria-labelledby="MTData" aria-hidden="true"
          style="display: none;">
        ...
        <script>
          $(function() {
              ...
              var table = $('#datatable-main').DataTable({
                  ...
                  ajax: {
                      method: "post",
                      url: "{{route('datauser.show', ['user' => 'view'])}}",
                      timeout: 120000,
                  ...
                  aoColumns: [
                      ...
                      }, 
                      {
                          ...
                          "render": function(data, row, type, meta) {
                              return '<button   title="Edit Data"  id="EditData" value="' + data.user_id + '" class="btn btn-primary waves-effect waves-light"><i class="fas fa-edit "></i></button> ' +
                                  ' <button title="Hapus Data"  id="Destroy" value="' + data.user_id + '" class="btn btn-danger waves-effect waves-light"><i class="fas fa-trash"></i></button>';
                  ...
                  Swal.fire({
                      ...
                      if (result.value) {
                          $.ajax({
                              ...
                              success: function(response) {
                                  $("#MTData").modal('show');
                                  $("#id_conten").val(response.data.user_id).change();
                                  $("#user_name").val(response.data.user_name).change(); 
                                  $("#first_name").val(response.data.first_name).change(); 
                                  $("#last_name").val(response.data.last_name).change(); 
                                  $("#password").val(response.data.apassword).change(); 
